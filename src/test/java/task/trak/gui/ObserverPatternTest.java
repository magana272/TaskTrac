...
public class ObserverPatternTest {
    ...
    public void testObserverReceivesNotificationOnUpdate() {
        ...
        vm.setAll(List.of(new SprintDTO(1L, "Proj", "Sprint1", List.of(), null, null, false, null)));
        List<ViewModelChangeType> received = new ArrayList<>();
        vm.addObserver(received::add);

        vm.update(new SprintDTO(1L, "Proj", "Sprint1-Updated", List.of(), null, null, false, null));
    ...
    public void testCrossDomainObservation_SprintViewObservesAllThree() {
        ...
        sprintVM.setAll(List.of(new SprintDTO(1L, "P", "S1", List.of(), null, null, false, null)));
